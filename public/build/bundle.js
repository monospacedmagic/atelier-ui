...
var app = (function () {
    ...
    function create_fragment$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(div, "class", "app_nav svelte-238kbf");
    ...
    /* src/editor/tabs/EditorDock.svelte generated by Svelte v3.16.7 */
    const file$2 = "src/editor/tabs/EditorDock.svelte";
    ...
    function create_fragment$2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(tab_1, file$2, 6, 8, 112);
    			attr_dev(div0, "class", "app_nav");
    			add_location(div0, file$2, 5, 4, 82);
    			attr_dev(h1, "class", "svelte-v5c4rk");
    			add_location(h1, file$2, 8, 4, 148);
    			attr_dev(div1, "class", "dock svelte-v5c4rk");
    ...
    function create_if_block_1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			div = element("div");
    			attr_dev(div, "class", div_class_value = "" + (/*type*/ ctx[1] + " divider" + " svelte-19yt68v"));
    			attr_dev(div, "style", div_style_value = "" + (/*side*/ ctx[7] + ": calc(" + /*pos*/ ctx[0] + "% - 0px)"));
    			add_location(div, file$3, 164, 2, 2801);
    		...
    		p: function update(ctx, dirty) {
    			if (dirty & /*type*/ 2 && div_class_value !== (div_class_value = "" + (/*type*/ ctx[1] + " divider" + " svelte-19yt68v"))) {
    ...
    function create_if_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			div = element("div");
    			attr_dev(div, "class", "mousecatcher svelte-19yt68v");
    			add_location(div, file$3, 169, 1, 2920);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div, anchor);
    		},
    ...
    function create_fragment$3(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(div0, "class", "pane svelte-19yt68v");
    			attr_dev(div0, "style", div0_style_value = "" + (/*dimension*/ ctx[8] + ": " + /*pos*/ ctx[0] + "%;"));
    			add_location(div0, file$3, 155, 1, 2612);
    			attr_dev(div1, "class", "pane svelte-19yt68v");
    			attr_dev(div1, "style", div1_style_value = "" + (/*dimension*/ ctx[8] + ": " + (100 - /*pos*/ ctx[0]) + "%;"));
    			add_location(div1, file$3, 159, 1, 2695);
    			attr_dev(div2, "class", "container svelte-19yt68v");
    			add_render_callback(() => /*div2_elementresize_handler*/ ctx[19].call(div2));
    			add_location(div2, file$3, 154, 0, 2517);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function create_a_slot_1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(section, file$4, 32, 2, 823);
    		},
    		m: function mount(target, anchor) {
    ...
    function create_a_slot(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			create_component(editordock.$$.fragment);
    			attr_dev(section, "slot", "a");
    			add_location(section, file$4, 42, 5, 1081);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, section, anchor);
    			mount_component(editordock, section, null);
    ...
    function create_b_slot_1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(section, file$4, 46, 5, 1141);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, section, anchor);
    			mount_component(editordock, section, null);
    ...
    function create_b_slot(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(section, "slot", "b");
    			set_style(section, "height", "100%");
    			add_location(section, file$4, 36, 2, 874);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, section, anchor);
    ...
    function create_fragment$4(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div, file$4, 24, 0, 604);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
