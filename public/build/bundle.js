...
var app = (function () {
    ...
    /* src/editor/EditorDock.svelte generated by Svelte v3.16.7 */

    const file$2 = "src/editor/EditorDock.svelte";
    ...
    function create_a_slot_1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(section, file$4, 32, 2, 818);
    		},
    		m: function mount(target, anchor) {
    ...
    function create_a_slot(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			create_component(editordock.$$.fragment);
    			attr_dev(section, "slot", "a");
    			add_location(section, file$4, 42, 5, 1076);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, section, anchor);
    			mount_component(editordock, section, null);
    ...
    function create_b_slot_1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(section, file$4, 46, 5, 1136);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, section, anchor);
    			mount_component(editordock, section, null);
    ...
    function create_b_slot(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(section, "slot", "b");
    			set_style(section, "height", "100%");
    			add_location(section, file$4, 36, 2, 869);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, section, anchor);
